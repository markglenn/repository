defmodule RepositoryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RepositoryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RepositoryWeb.Gettext, "errors", msg, opts)
    end
  end
