defmodule RepositoryWeb.ItemLiveTest do
  use RepositoryWeb.ConnCase

  import Phoenix.LiveViewTest
  import Repository.MaterialsFixtures

  @create_attrs %{archived_at: "2023-01-30T00:58:00", name: "some name"}
  @update_attrs %{archived_at: "2023-01-31T00:58:00", name: "some updated name"}
